...
public class Main {
    public static void main(String[] args) {
        ...
        final int numerodeimagenesaprocesar = 20;  //numero de invariantes que buscamos, POR ALGUNA RAZON CON MENOS DE 19 SE ROMPE LA EXPRESION REGULAR AL ANALIZAR XDDDDD  
